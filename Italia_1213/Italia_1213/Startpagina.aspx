<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ItaliaMasterPage.Master" CodeBehind="Startpagina.aspx.vb" Inherits="Italia_1213.Startpagina" %>
...
<h2>
        ...
        <a href="http://www.facebook.com/immaculatamalle" target="_blank">
            <asp:Image ID="Image00" class="map" runat="server" ImageUrl="~/img/facebook_logo.png" Height="38px" BorderStyle="None" ImageAlign="Right"/>
        </a>&nbsp
        <a href="http://www.immalle.be" target="_blank">
            <asp:Image ID="Image0" class="map" runat="server" ImageUrl="~/img/temp.jpg" Height="40px" BorderStyle="None" ImageAlign="Right"/>
        </a>
        </h2>
        ...
        een evenwicht. Sommigen kunnen er hun collectie t-shirts aanvullen.
        </p>

        <p>
        Langs het Middeleeuwse Assisi rijden we naar Rome. Een dag vullen we met het 
        Oude Rome: de thermen, het Colosseum, Forum Romanum …
        </p>
        ...
        boven en langs onder.
        </p>

        <p>
        In de Vaticaanse musea herinneren we ons de Esthetica- powerpoints: de Laocoön, 
        de School van Athene, het scheppend vingertje in de Sixtijnse kapel.
        </p>
        ...
        voetbal als facultatief op het programma.
        </p>
